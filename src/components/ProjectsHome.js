    ...
    return (
        <section id='projects'>
            ...
            <div className='bento reveal' ref={bentoRef}>
                <Link className='card c-tall feat' to='/Project'>
                ...
                <Link className='card c-wide' to='/Project'>
                ...
                <Link className='card c-sq' to='/Project'>
                ...
                <Link className='card c-mid' to='/Project'>
